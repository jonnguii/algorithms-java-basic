...
# Stack escolhida para resolução: Java

# Exercícios classificados
```

Ex01 - Soma e Comparação com C
Ex02 - Número Par ou Ímpar e Positivo ou Negativo
Ex03 - Soma ou Multiplicação entre Valores
Ex04 - Antecessor e Sucessor
Ex05 - Quantidade de Salários Mínimos
Ex06 - Reajuste de 5%
...
Ex12 - Formas de Pagamento
Ex13 - Maior ou Menor de Idade
Ex14 - Troca de Valores entre A e B
Ex15 - Cálculo de Idade em Anos, Meses e Dias
Ex16 - Verificação de Tipo de Triângulo
Ex17 - Conversão de Fahrenheit para Celsius
Ex18 - Crescimento de Francisco e Sara
Ex19 - Tabuada de 1 até 10
Ex20 - Tabuada de um Número Inteiro
Ex21 - Número Aleatório entre 0 e 100
Ex22 - Quociente e Resto da Divisão Inteira
Ex23 - Cálculo de Salário Líquido do Professor
Ex24 - Consumo de Combustível em Viagem

```
# Exercícios por extenso
...
3 - Faça um algoritmo que leia dois valores inteiros A e B, se os valores de A e B forem iguais, deverá somar os dois valores, caso contrário deverá
...
5 - Faça um algoritmo que leia o valor do salário mínimo e o valor do salário de um usuário, calcule quantos salários mínimos esse usuário ganha e 
...
11 - Faça um algoritmo que leia quatro notas obtidas por um aluno, calcule a média das nota obtidas, imprima na tela o nome do aluno e se o aluno foi 
aprovado ou reprovado. Para o aluno ser considerado aprovado sua média final deve ser maior ou igual a 7.

12 - Faça um algoritmo que leia o valor de um produto e determine o valor que deve ser pago, conforme a escolha da forma de pagamento pelo comprador e 
...
15 - Faça um algoritmo que leia o ano em que uma pessoa nasceu, imprima na tela quantos anos, meses e dias essa pessoa ja viveu. Leve em consideração o ano com 
365 dias e o mês com 30 dias. (Ex: 5 anos, 2 meses e 15 dias de vida)
...
22 - Faça um algoritmo que calcule a quantidade de litros de combustível gastos em uma viagem, sabendo que o carro faz 12km com um litro. Deve-se fornecer ao 
